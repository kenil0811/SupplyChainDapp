...
//    console.log("\n");
	...
	var rbCost = Number(req.body.rbCost);
	var wbCost = Number(req.body.wbCost);
	var dbCost = Number(req.body.dbCost);
	var fbCost = Number(req.body.fbCost);
	var boCost = [rbCost,wbCost,dbCost,fbCost];
